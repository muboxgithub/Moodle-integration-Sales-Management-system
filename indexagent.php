...
<nav  class="navbar navbar-expand-lg shadow fixed-top heghttt" style="background-color: #ffff;">
        ...
        <a class="navbar-brand">
            <img class="rounded-circle"  width="200" height="100" src="./logo.png"/>
            </a>     
...
?>
       ...
       <span class="form-control badge bg-primary mx-2" id="selectedPromocode" style="font-size: 15px;">
...
<div class="dropdown-menu dropdown-menu-end ">
    ...
    <a class="dropdown-item hoverdropdown" href="logout.php">Logout</a> -->
                ...
                <li class="nav-item m-1 p-1">
                    <a href="#" class="nav-link text-white text-capitalize btn rounded fs-10 me-5" style="background-color: #9932cc;color:white;">Dashboard agent</a>
                </li>
...
<div class="col-sm-6">
<canvas id="barGraph" width="300" height="200"></canvas>
</div>
<div class="col-sm-6">
...
UpdateOnlineusers(globalagentcode,'true');//update in 1000 microsecods
...
Bargraphsystem(globalagentcode,'true'); // Initialize the function
